 var routes = [{
    ...
    },
    {
        ...
        route: 'peetyCashAddEdit/:id(/:projectId)(/:isApproval)(/:acWorkFlowId)(/:arrage)',
        moduleId: 'logs/peetyCashAddEdit',
        title: 'peetyCash',
        nav: true
    }, {
        route: 'peetyCashAddEditInMenu/:id(/:projectId)(/:isApproval)(/:acWorkFlowId)(/:arrage)(/:projectName)',
        ...
        route: 'expensesUserAddEdit/:id(/:workFlowId)(/:workFlowItemId)(/:arrange)(/:cycleId)',
        ...
        nav: true,
        hash: '#Rfi',
        settings: { Communication: true, permission: 79, caption: 'procoor-icon-RFIs', order: 4 }
    }, {
        ...
        nav: true,
        hash: '#Letters',
        settings: { Communication: true, permission: 52, caption: 'procoor-icon-letters', order: 1 }
    }, {
        route: 'rfiAddEdit/:param1(/:projectId)(/:isApproval)(/:acWorkFlowId)(/:arrage)(/:projectName)(/:isInbox)(/:isDistribution)',
        ...
        route: 'lettersAddEdit/:param1(/:projectId)(/:isApproval)(/:acWorkFlowId)(/:arrage)(/:projectName)(/:isInbox)(/:isDistribution)',
        ...
        nav: true,
        hash: '#Phone',
        settings: { Communication: true, permission: 93, caption: 'procoor-icon-telephone-records', order: 9 }
    }, {
        route: 'phoneAddEdit/:param1(/:projectId)(/:isApproval)(/:acWorkFlowId)(/:arrage)(/:projectName)(/:isInbox)(/:isDistribution)',
        moduleId: 'communication/phoneAddEdit',
        title: 'Phone Add',
        nav: false,
        settings: { Communication: false }
    }, {
        route: 'requestProposalAddEdit/:id(/:projectId)(/:isApproval)(/:acWorkFlowId)(/:arrage)(/:projectName)(/:isInbox)(/:isDistribution)',
        ...
        settings: { Procurement: true, permission: 61, caption: 'procoor-icon-proposal-request', order: 7 }
    }, {
        ...
        nav: true,
        hash: '#Proposal',
        settings: { Procurement: true, permission: 70, caption: 'procoor-icon-proposal', order: 8 }
    }, {
        route: 'proposalAddEdit/:id(/:projectId)(/:isApproval)(/:acWorkFlowId)(/:arrage)(/:projectName)(/:isInbox)(/:isDistribution)',
        ...
        nav: true,
        hash: '#Reports',
        settings: { Communication: true, permission: 427, caption: 'procoor-icon-reports', order: 12 }
    }, {
        route: 'reportsAddEdit/:id(/:projectId)(/:isApproval)(/:acWorkFlowId)(/:arrage)(/:projectName)(/:isInbox)(/:isDistribution)',
        ...
        nav: true,
        hash: '#InternalMemo',
        settings: { Communication: true, permission: 102, caption: 'procoor-icon-internal-memo', order: 2 }
    }, {
        route: 'internalMemoAddEdit/:id(/:projectId)(/:isApproval)(/:acWorkFlowId)(/:arrage)(/:projectName)(/:isInbox)(/:isDistribution)',
        ...
        route: 'emailAddEdit/:id(/:projectId)(/:isApproval)(/:acWorkFlowId)(/:arrage)(/:projectName)(/:isInbox)(/:isDistribution)',
        ...
        nav: true,
        hash: '#Email',
        settings: { Communication: true, permission: 395, caption: 'procoor-icon-email-records', order: 8 }
    }, {
        route: 'corrRecievedSent(/:isWidget)',
        moduleId: 'communication/corrRecievedSent',
        title: 'correspondence',
        nav: true,
        hash: '#corrRecievedSent',
        settings: { Communication: true, permission: 42, caption: 'procoor-icon-email-records', order: 13 }
    },
    {
    ...
    {
        route: 'correspondenceReceivedAddEdit/:id(/:projectId)(/:isApproval)(/:acWorkFlowId)(/:arrage)(/:projectName)(/:isInbox)(/:isDistribution)',
        moduleId: 'communication/correspondenceReceivedAddEdit',
        title: 'Correspondence Received Addition',
        nav: false,
        settings: { Communication: false }
    }, {
        route: 'projectTaskGroupAddEdit/:id(/:projectId)(/:isApproval)(/:acWorkFlowId)(/:arrage)(/:projectName)(/:isInbox)(/:isDistribution)',
        ...
        route: 'autoDeskViewer/:fileName(/:path)(/:id)(/:docTypeId)(/:fileId)(/:projectId)',
        moduleId: 'panels/autoDeskViewer',
        title: 'Auto Desk ',
        nav: true
    }, {
        route: 'autoDeskPDFViewer/:fileName(/:path)(/:id)(/:docTypeId)(/:fileId)(/:projectId)',
        moduleId: 'panels/autoDeskPDFViewer',
        title: 'Auto Desk ',
        nav: true
    }, {
        route: 'autoDeskPDFViewerNew/:fileName(/:path)(/:id)(/:docTypeId)(/:fileId)(/:projectId)',
        ...
        nav: true,
        settings: { Site: true, permission: 554, caption: 'procoor-icon-pictures', order: 12 }
    }, {
        ...
        title: 'Companies',
        nav: true,
        settings: { Communication: true, permission: 4, caption: 'procoor-icon-companies', order: 15 }
    }, {
        route: 'projectWorkFlow',
        moduleId: 'projects/projectWorkFlow',
        title: 'workFlow',
        nav: true,
        settings: { General: true, permission: 604, caption: 'procoor-icon-workflow', order: 1 }
    }, {
        ...
        nav: true,
        settings: { General: false, permission: 464, caption: 'procoor-icon-organization-chart' }
    }, {
        route: 'projectDistributionList',
        moduleId: 'projects/projectDistributionList',
        title: 'distributionList',
        nav: true,
        settings: { General: true, permission: 629, caption: 'procoor-icon-distribution-list', order: 2 }
    }, {
        route: 'projectProjectHeaderFooter',
        moduleId: 'projects/projectProjectHeaderFooter',
        title: 'headerAndFooter',
        nav: true,
        settings: { General: true, permission: 484, caption: 'procoor-icon-project-page-setup', order: 5 }
    }, {
        ...
        route: 'projectDistributionListAddEdit/:id(/:projectId)(/:isApproval)(/:acWorkFlowId)(/:arrage)(/:projectName)(/:isInbox)(/:isDistribution)',
        ...
        title: 'projectsForms',
        nav: true,
        settings: { General: false, permission: 907, caption: 'procoor-icon-general-forms' }
    }, {
        route: 'accountsAlerts',
        moduleId: 'accounts/accountsAlerts',
        title: 'docAlerts',
        nav: true,
        settings: { General: true, permission: 108, caption: 'procoor-icon-alerts', order: 6 }
    }, {
        route: 'accountsBic',
        moduleId: 'accounts/accountsBic',
        title: 'bicAlerts',
        nav: true,
        settings: { General: true, permission: 109, caption: 'procoor-icon-BIC', order: 7 }
    }, {
        ...
        settings: { Communication: true, permission: 456, caption: 'procoor-icon-meeting-agenda', order: 5 }
    }, {
        route: 'meetingAgendaAddEdit/:id(/:projectId)(/:isApproval)(/:acWorkFlowId)(/:arrage)(/:projectName)(/:isInbox)(/:isDistribution)',
        moduleId: 'communication/meetingAgendaAddEdit',
        title: 'Meeting Agenda Addition',
        nav: false,
        settings: { Communication: false }
    }, {
        route: 'projectWorkFlowAddEdit/:id(/:projectId)(/:isApproval)(/:acWorkFlowId)(/:arrage)(/:projectName)(/:isInbox)(/:isDistribution)',
        ...
        nav: true,
        settings: { Communication: true, permission: 508, caption: 'procoor-icon-internal-meeting-minutes', order: 6 }
    }, {
        ...
        nav: true,
        settings: { Communication: true, permission: 111, caption: 'procoor-icon-external-meeting-minutes', order: 7 }
    }, {
        route: 'meetingMinutesAddEdit/:Id(/:projectId)(/:isApproval)(/:acWorkFlowId)(/:arrage)(/:projectName)(/:isInbox)(/:isDistribution)',
        ...
        nav: true,
        hash: '#Transmittal',
        settings: { Communication: true, permission: 88, caption: 'procoor-icon-transmittals', order: 3 }
    }, {
        route: 'transmittalAddEdit/:Id(/:projectId)(/:isApproval)(/:acWorkFlowId)(/:arrage)(/:projectName)(/:isInbox)(/:isDistribution)',
        ...
        settings: { Time: true, permission: 33, caption: 'procoor-icon-schedule', order: 3 }
    }, {
        route: 'projectScheduleAddEdit/:id(/:projectId)(/:isApproval)(/:acWorkFlowId)(/:arrage)(/:projectName)(/:isInbox)(/:isDistribution)',
        ...
        settings: { Time: true, permission: 586, caption: 'procoor-icon-primavera', order: 4 }
    }, {
        route: 'projectPrimaveraScheduleAddEdit/:id(/:projectId)(/:isApproval)(/:acWorkFlowId)(/:arrage)(/:projectName)(/:isInbox)(/:isDistribution)',
        ...
        title: 'projectTask',
        nav: true,
        settings: { Time: true, permission: 361, caption: 'procoor-icon-task', order: 1 }
    }, {
        route: 'projectTaskAddEdit/:id(/:projectId)(/:isApproval)(/:acWorkFlowId)(/:arrage)(/:projectName)(/:isInbox)(/:isDistribution)',
        ...
        nav: true,
        hash: '#boq',
        settings: { Contracts: true, caption: 'procoor-icon-BOQ', permission: 620, order: 1 }
    }, {
        route: 'boqAddEdit/:param1(/:projectId)(/:isApproval)(/:acWorkFlowId)(/:arrage)(/:projectName)(/:isInbox)(/:isDistribution)',
        ...
        nav: true,
        hash: '#qs',
        settings: { Contracts: true, caption: 'procoor-icon-qauntity-survey', permission: 769, order: 4 }
    }, {
        ...
        hash: '#contractInfo',
        nav: true,
        settings: { Contracts: true, caption: 'procoor-icon-contracts', permission: 143, order: 2 }
    }, {
        route: 'contractInfoAddEdit/:param1(/:projectId)(/:isApproval)(/:acWorkFlowId)(/:arrage)(/:projectName)(/:isInbox)(/:isDistribution)',
        ...
        nav: true,
        hash: '#procurement',
        settings: { Procurement: true, caption: 'procoor-icon-procurement', permission: 170, order: 9 }
    }, {
        route: 'procurementAddEdit/:param1(/:projectId)(/:isApproval)(/:acWorkFlowId)(/:arrage)(/:projectName)(/:isInbox)(/:isDistribution)',
        ...
        nav: true,
        hash: '#pco',
        settings: { Contracts: true, caption: 'procoor-icon-PCO', permission: 152, order: 8 }
    }, {
        route: 'pcoAddEdit/:param1(/:projectId)(/:isApproval)(/:acWorkFlowId)(/:arrage)(/:projectName)(/:isInbox)(/:isDistribution)',
        moduleId: 'contracts/pcoAddEdit',
        title: ' contract PCO ',
        nav: false,
        settings: { Contracts: false }
    }, {
        route: 'qsAddEdit/:param1(/:projectId)(/:isApproval)(/:acWorkFlowId)(/:arrage)(/:projectName)(/:isInbox)(/:isDistribution)',
        ...
        settings: { Contracts: true, caption: 'procoor-icon-payment-requisitions', permission: 188, order: 5 }
    }, {
        ...
        nav: true,
        hash: '#siteRequest',
        settings: { Procurement: true, caption: 'procoor-icon-site-request', permission: 120, order: 1 }
    }, {
        route: 'siteRequestAddEdit/:param1(/:projectId)(/:isApproval)(/:acWorkFlowId)(/:arrage)(/:projectName)(/:isInbox)(/:isDistribution)',
        ...
        route: 'variationRequestAddEdit/:param1(/:projectId)(/:isApproval)(/:acWorkFlowId)(/:arrage)(/:projectName)(/:isInbox)(/:isDistribution)',
        ...
        nav: true,
        hash: '#changeOrder',
        settings: { Contracts: true, caption: 'procoor-icon-change-order', permission: 161, order: 9 }
    }, {
        route: 'changeOrderAddEdit/:param1(/:projectId)(/:isApproval)(/:acWorkFlowId)(/:arrage)(/:projectName)(/:isInbox)(/:isDistribution)',
        ...
        nav: true,
        hash: '#costCodingTree',
        settings: { Contracts: false, caption: 'procoor-icon-cost-coding-tree', permission: 138 }
    }, {
        route: 'costCodingTreeAddEdit/:id(/:projectId)(/:isApproval)(/:acWorkFlowId)(/:arrage)(/:projectName)',
        ...
        nav: true,
        hash: '#projectIssues',
        settings: { Contracts: false, caption: 'procoor-icon-Issues', permission: 24 }
    }, {
        ...
        nav: true,
        hash: '#purchaseOrder',
        settings: { Procurement: true, caption: 'procoor-icon-purchase-order', permission: 179, order: 2 }
    }, {
        route: 'invoicesForPoAddEdit/:param1(/:projectId)(/:isApproval)(/:acWorkFlowId)(/:arrage)(/:projectName)(/:isInbox)(/:isDistribution)',
        ...
        nav: true,
        hash: '#invoicesForPo',
        settings: { Procurement: true, caption: 'procoor-icon-invoices-for-PO', permission: 197, order: 10 }
    }, {
        route: 'dailyReportsAddEdit/:id(/:projectId)(/:isApproval)(/:acWorkFlowId)(/:arrage)(/:projectName)(/:isInbox)(/:isDistribution)',
        ...
        nav: true,
        hash: '#dailyReports',
        settings: { Site: true, permission: 269, caption: 'procoor-icon-daily-report', order: 10 }
    }, {
        ...
        settings: { QualityControl: true, permission: 934, caption: 'procoor-icon-material-inspection', order: 6 }
    }, {
        route: 'materialInspectionRequestAddEdit/:id(/:projectId)(/:isApproval)(/:acWorkFlowId)(/:arrage)(/:projectName)(/:isInbox)(/:isDistribution)',
        ...
        nav: true,
        hash: '#drawing',
        settings: { Design: true, caption: 'procoor-icon-drawing', permission: 3520 }
    }, {
        ...
        route: 'addEditDrawing/:id(/:projectId)(/:isApproval)(/:acWorkFlowId)(/:arrage)(/:projectName)(/:projectName)',
        moduleId: 'design/addEditDrawing',
        title: 'Drawing Addition',
        nav: false,
        settings: { Design: false }
    }, {
        route: 'addEditModificationDrawing/:id(/:projectId)(/:isApproval)(/:acWorkFlowId)(/:arrage)(/:projectName)(/:projectName)',
        ...
        nav: true,
        hash: '#submittal',
        settings: { Site: true, permission: 224, caption: 'procoor-icon-submittal', order: 1 }
    }, {
        route: 'submittalAddEdit/:id(/:projectId)(/:isApproval)(/:acWorkFlowId)(/:arrage)(/:projectName)(/:isInbox)(/:isDistribution)',
        moduleId: 'site/submittalAddEdit',
        title: 'Site Addition',
        nav: false,
        settings: { Site: false }
    }, {
        route: 'submittalSetsAddEdit/:id(/:projectId)(/:isApproval)(/:acWorkFlowId)(/:arrage)(/:projectName)(/:isInbox)(/:isDistribution)',
        ...
        route: 'drawingSetsAddEdit/:id(/:projectId)(/:isApproval)(/:acWorkFlowId)(/:arrage)(/:projectName)(/:isInbox)(/:isDistribution)',
        ...
        settings: { Site: true, permission: 639, caption: 'procoor-icon-site-instructions', order: 4 }
    }, {
        route: 'siteInstructionsAddEdit/:id(/:projectId)(/:isApproval)(/:acWorkFlowId)(/:arrage)(/:projectName)(/:isInbox)(/:isDistribution)',
        moduleId: 'site/siteInstructionsAddEdit',
        title: 'Site Instructions Addition',
        nav: false,
        settings: { Site: false }
    }, {
        route: 'drawingListAddEdit/:id(/:projectId)(/:isApproval)(/:acWorkFlowId)(/:arrage)(/:projectName)(/:isInbox)(/:isDistribution)',
        ...
        settings: { Procurement: true, permission: 251, caption: 'procoor-icon-material-release', order: 5 }
    }, {
        ...
        title: 'materialInventory',
        nav: true,
        settings: { Procurement: true, permission: 618, caption: 'procoor-icon-project-inventory', order: 4 }
    }, {
        route: 'TransferInventory/:id(/:inventoryId)(/:projectId)(/:isApproval)(/:acWorkFlowId)(/:arrage)',
        ...
        title: 'transferToProject',
        nav: true,
        settings: { Procurement: true, permission: 618, caption: 'procoor-icon-project-inventory', order: 7 }
    }, {
        route: 'materialInventoryAddEdit/:id(/:projectId)(/:isApproval)(/:acWorkFlowId)(/:arrage)(/:projectName)(/:isInbox)(/:isDistribution)',
        moduleId: 'site/materialInventoryAddEdit',
        title: 'Project Inventory Addition',
        nav: false,
        settings: { Procurement: false }
    }, {
        route: 'materialReleaseAddEdit/:id(/:projectId)(/:isApproval)(/:acWorkFlowId)(/:arrage)(/:projectName)(/:isInbox)(/:isDistribution)',
        moduleId: 'site/materialReleaseAddEdit',
        title: 'Material Release Addition',
        nav: false,
        settings: { Procurement: false }
    }, {
        route: 'materialReturnedAddEdit/:id(/:projectId)(/:isApproval)(/:acWorkFlowId)(/:arrage)(/:projectName)(/:isInbox)(/:isDistribution)',
        ...
        settings: { Procurement: true, permission: 242, caption: 'procoor-icon-material-delivery', order: 3 }
    }, {
        route: 'materialDeliveryAddEdit/:id(/:projectId)(/:isApproval)(/:acWorkFlowId)(/:arrage)(/:projectName)(/:isInbox)(/:isDistribution)',
        ...
        settings: { QualityControl: true, permission: 370, caption: 'procoor-icon-inspection-request', order: 5 }
    }, {
        route: 'inspectionRequestAddEdit/:id(/:projectId)(/:isApproval)(/:acWorkFlowId)(/:arrage)(/:projectName)(/:isInbox)(/:isDistribution)',
        ...
        nav: true,
        hash: '#tenderAnalysis',
        settings: { Estimation: true, permission: 573, caption: 'procoor-icon-tender-analysis', order: 1 }
    }, {
        route: 'tenderAnalysisAddEdit/:id(/:projectId)(/:isApproval)(/:acWorkFlowId)(/:arrage)(/:projectName)(/:isInbox)(/:isDistribution)',
        ...
        nav: true,
        hash: '#budgetFile',
        settings: { Estimation: false, permission: 689, caption: 'procoor-icon-budget-file' }
    }, {
        ...
        nav: true,
        hash: '#budgetExpenses',
        settings: { Estimation: true, permission: 413, caption: 'procoor-icon-budgeted-expenses', order: 4 }
    }, {
        route: 'punchList',
        moduleId: 'commonLogs',
        title: 'punchList',
        nav: true,
        hash: '#punchList',
        settings: { QualityControl: true, permission: 278, caption: 'procoor-icon-punch-list', order: 7 }
    }, {
        route: 'punchListAddEdit/:id(/:projectId)(/:isApproval)(/:acWorkFlowId)(/:arrage)(/:projectName)(/:isInbox)(/:isDistribution)',
        ...
        nav: true,
        hash: '#base',
        settings: { Estimation: true, permission: 581, caption: 'procoor-icon-estimation-base', order: 3 }
    }, {
        route: 'baseAddEdit/:id(/:projectId)(/:isApproval)(/:acWorkFlowId)(/:arrage)(/:projectName)(/:isInbox)(/:isDistribution)',
        ...
        settings: { Estimation: true, permission: 595, caption: 'procoor-icon-project-estimate', order: 2 }
    }, {
        route: 'projectEstimateAddEdit/:id(/:projectId)(/:isApproval)(/:acWorkFlowId)(/:arrage)(/:projectName)(/:isInbox)(/:isDistribution)',
        ...
        settings: { Site: true, caption: 'procoor-icon-invoicesforPO', permission: 3137, order: 11 }
    }, {
        route: 'clientModificationAddEdit/:param1(/:projectId)(/:isApproval)(/:acWorkFlowId)(/:arrage)(/:projectName)(/:isInbox)(/:isDistribution)',
        ...
        nav: true,
        hash: '#qualityControl',
        settings: { QualityControl: true, permission: 287, caption: 'procoor-icon-quality-control', order: 8 }
    }, {
        route: 'qualityControlAddEdit/:id(/:projectId)(/:isApproval)(/:acWorkFlowId)(/:arrage)(/:projectName)(/:isInbox)(/:isDistribution)',
        ...
        nav: true,
        hash: '#weeklyReports',
        settings: { Site: true, permission: 788, caption: 'procoor-icon-weekly-report', order: 11 }
    }, {
        route: 'weeklyReportsAddEdit/:id(/:projectId)(/:isApproval)(/:acWorkFlowId)(/:arrage)(/:projectName)(/:isInbox)(/:isDistribution)',
        ...
        settings: { Site: true, permission: 3151, caption: 'fa fa-signal', order: 10 }
    }, {
        route: 'clientSelectionAddEdit/:id(/:projectId)(/:isApproval)(/:acWorkFlowId)(/:arrage)(/:projectName)(/:isInbox)(/:isDistribution)',
    ...
    },
    {
        ...
        title: 'taskTree',
        nav: true,
        settings: { permission: 814, caption: 'procoor-icon-task-tree', order: 2 }
    }, {
        route: 'myTasks',
        ...
        nav: true,
        hash: '#Ncr',
        settings: { QualityControl: true, permission: 921, caption: 'procoor-icon-NCR', order: 9 }
    }, {
        route: 'overTime',
        ...
        route: 'NCRAddEdit/:id(/:projectId)(/:isApproval)(/:acWorkFlowId)(/:arrage)(/:projectName)(/:isInbox)(/:isDistribution)',
        ...
        settings: { Procurement: true, permission: 260, caption: 'procoor-icon-material-delivery', order: 11 }
    }, {
        route: 'equipmentDeliveryAddEdit/:id(/:projectId)(/:isApproval)(/:acWorkFlowId)(/:arrage)(/:projectName)(/:isInbox)(/:isDistribution)',
        ...
        moduleId: 'reports/submittalsPerNeighBorhood',
        ...
        title: 'area',
        nav: true,
        settings: { General: true, permission: 3784, caption: 'procoor-icon-BIC', order: 8 }
    }, {
        route: 'location',
        moduleId: 'projectEps/location',
        title: 'location',
        nav: true,
        settings: { General: true, permission: 3788, caption: 'procoor-icon-BIC', order: 9 }
    }, {
        route: 'building',
        moduleId: 'projectEps/building',
        title: 'Buildings',
        nav: true,
        settings: { General: true, permission: 4012, caption: 'procoor-icon-BIC', order: 10 }
    }, {
        route: 'unit',
