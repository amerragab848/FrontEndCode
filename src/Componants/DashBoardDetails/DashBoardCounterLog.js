...
export default class DashBoardCounterLog extends Component {
    ...
    componentDidMount = () => {
        Api.get(this.props.apiDetail).then
            (
                res => {
                    this.setState({
                        renderGrid: true,
    ...
    filterMethodMain = (event, query, apiFilter) => {
        ...
        this.setState({
            ...
            let url = this.props.apiFilter + '&query=' + _query[0] + '}'
    ...
    render() {
        ...
        const btnExport =
            <Export rows={this.state.rows} columns={this.props.columns} fileName={Resources[this.props.title][currentLanguage]} />
        ...
        return (
            ...
            <div className="mainContainer">
                ...
                <div className="subFilter">
                        <h3 className="zero">{this.props.title}</h3>
                    ...
                    <div>
                        {this.state.renderGrid ?
                            <GridSetup rows={this.state.rows} columns={this.props.columns} showCheckbox={false} />
                            : <LoadingSection />}
                    </div>
