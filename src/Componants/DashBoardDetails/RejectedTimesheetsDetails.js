    ...
    render() {
        ...
        const dataGrid =
            this.state.isLoading === false ?
                <GridSetup rows={this.state.rows} columns={this.state.columns} NoShowToolBar={true}
                    selectedRows={this.selectedRows.bind(this)} DeSelectedRows={this.onRowsDeselected.bind(this)} /> : <LoadingSection />
        ...
        const ComponantFilter =
            this.state.isLoading === false ?
                <Filter filtersColumns={this.state.filtersColumns} apiFilter={this.state.apiFilter} filterMethod={this.filterMethodMain} />
                : <LoadingSection />
