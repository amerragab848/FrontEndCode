                        ...
                        >
                            {({ touched, errors, handleBlur, handleChange, values }) => (
                                <Form id="signupForm1" className="proForm customProform" noValidate="novalidate" >
                                    ...
                                    <Dropdown title="title" data={this.props.titleData} defaultValue={this.state.selectedTitle}
                                    ...
                                    <div className={errors.ContactNameEn && touched.ContactNameEn || this.state.exitsNameEn ? (
                                        "ui input inputDev fillter-item-c has-error"
                                    ) : !errors.password && touched.password ? (
                                        "ui input inputDev fillter-item-c has-success"
                                    ) : "ui input inputDev fillter-item-c"}
                                    ...
                                    <div className={errors.ContactNameAr && touched.ContactNameAr || this.state.exitsNameAr ? (
                                        "ui input inputDev fillter-item-c has-error"
                                    ) : !errors.password && touched.password ? (
                                        "ui input inputDev fillter-item-c has-success"
                                    ) : "ui input inputDev fillter-item-c"}
