        ...
        let tabel =
            this.props.isLoadingFiles == true
                ? this.props.files.map((item, Index) => {
                    ...
                    if (Config.getPublicConfiguartion().cdn !== Config.getPublicConfiguartion().cdnMap) {
                        attachFile = item['attachFile'].replace(Config.getPublicConfiguartion().cdn, Config.getPublicConfiguartion().cdnMap);
                    }
                    if (item.fileName) {
