                                    ...
                                    <div className="letterFullWidth proForm  first-proform proform__twoInput">
                                        <div className="linebylineInput valid-input">
                                            ...
                                            <div className={"inputDev ui input " + (errors.description ? 'has-error' : !errors.description && touched.description ? (" has-success") : " ")}>
                                                <input name='description' className="form-control" autoComplete='off'
                                                    id="description" placeholder={Resources['description'][currentLanguage]}
                                                    onBlur={handleBlur} value={this.state.itemDescription.description}
                                    ...
                                    <div className="proForm datepickerContainer">
                                        ...
                                        <div className="linebylineInput valid-input">
                                            ...
                                            <div className="ui input inputDev"  >
                                                <input type="text" className="form-control" id="quantity" name="quantity" onBlur={handleBlur}
                                                    value={this.state.itemDescription.quantity} placeholder={Resources.quantity[currentLanguage]}
                                        ...
                                        <div className="linebylineInput valid-input">
                                            ...
                                            <div className="ui input inputDev"  >
                                                <input type="text" className="form-control" id="unitPrice" value={this.state.itemDescription.unitPrice}
                                                    placeholder={Resources.unitPrice[currentLanguage]}
                                                    name="unitPrice" onBlur={handleBlur} onChange={(e) => this.handleChangeItem(e, 'unitPrice')} />
                                        ...
                                        <div className="linebylineInput valid-input">
                                            ...
                                            <div className={"inputDev ui input " + (errors.itemCode ? 'has-error' : !errors.itemCode && touched.itemCode ? (" has-success") : " ")}>
                                                <input name='itemCode' className="form-control" autoComplete='off'
                                                    id="itemCode" placeholder={Resources['itemCode'][currentLanguage]}
                                        ...
                                        <div className="linebylineInput valid-input">
                                            ...
                                            <div className="inputDev ui input has-success">
                                                <input name='resourceCode' className="form-control" id="resourceCode" autoComplete='off'
                                        ...
                                        <div className="linebylineInput valid-input">
                                            <label className="control-label">{Resources.unitPrice[currentLanguage]}</label>
                                            <div className="ui input inputDev"  >
                                                <input type="text" className="form-control" id="unitPrice" placeholder={Resources.unitPrice[currentLanguage]}
                                                    value={this.state.itemDescription.unitPrice} name="unitPrice" onBlur={handleBlur}
                                        ...
                                        <div className="linebylineInput valid-input">
                                            ...
                                            <div className={"inputDev ui input " + (errors.days ? 'has-error' : !errors.days && touched.days ? (" has-success") : " ")}>
                                                <input name='days' autoComplete='off' className="form-control"
                                                    id="days" placeholder={Resources['days'][currentLanguage]}
                                                    onBlur={handleBlur} value={this.state.itemDescription.days}
                                        ...
                                        <div className={"linebylineInput valid-input " + (this.props.showItemType !== false ? ' ' : ' disNone')}>
                                            <Dropdown title="itemType" data={this.state.itemTypes} selectedValue={this.state.selectedItemType}
                                                ...
                                                touched={touched.itemType} name="itemType" index="itemType"
...
export default connect(mapStateToProps, mapDispatchToProps)(withRouter(AddEditItems))