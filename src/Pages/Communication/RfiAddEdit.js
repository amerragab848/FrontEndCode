            ...
            <div className="mainContainer">
                ...
                <div className={this.state.isViewMode === true ? "documents-stepper noTabs__document readOnly_inputs" : "documents-stepper noTabs__document"}>
                    <div className="submittalHead">
                        <h2 className="zero">{Resources.requestInformation[currentLanguage]}
                                                    ...
                                                    <div className="proForm datepickerContainer"> 
                                                        ...
                                                        <div className="linebylineInput valid-input">
                                                            <div className={"ui input inputDev fillter-item-c " + (this.state.document.fromContactId ? (" has-error") : !errors.fromContactId ? (" has-success") : " ")}>
                                                                <Dropdown title="fromContact" isMulti={false} data={this.state.fromContacts} selectedValue={this.state.selectedFromContact}
                                                        ...
                                                        <div className="linebylineInput valid-input">
                                                            <div className={"ui input inputDev fillter-item-c " + (errors.toCompanyId && touched.toCompanyId ? (" has-error") : !errors.toCompanyId && touched.toCompanyId ? (" has-success") : " ")}>
                                                                <Dropdown title="toCompany"  isMulti={false} data={this.state.companies} selectedValue={this.state.selectedToCompany}
                                                        ...
                                                        <div className="linebylineInput valid-input">
                                                            <div className={"ui input inputDev fillter-item-c " + (errors.toContactId && touched.toContactId ? (" has-error") : !errors.toContactId && touched.toContactId ? (" has-success") : "")}>
                                                                <Dropdown title="toContactName" isMulti={false} data={this.state.ToContacts} selectedValue={this.state.selectedToContact}
                                                        ...
                                                        <div className="linebylineInput valid-input">
                                                            <Dropdown title="discipline" data={this.state.discplines} selectedValue={this.state.selectedDiscpline}
                                                                handleChange={event => this.handleChangeDropDown(event, 'disciplineId', false, '', '', '', 'selectedDiscpline')}
                                                                index="letter-discipline" />
                                                        </div>
                                                        <div className="linebylineInput valid-input">
                                                            <Dropdown title="replyletter" data={this.state.letters} selectedValue={this.state.selectedReplyLetter}
                                                        ...
                                                        <div className="linebylineInput valid-input">
                                                            ...
                                                            <div className="inputDev ui input">
                                                                <RichTextEditor value={this.state.message} onChange={this.onChangeMessage.bind(this)}/>
                                                            </div>
                                                        </div>
                                                    </div>
