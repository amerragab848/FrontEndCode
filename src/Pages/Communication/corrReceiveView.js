...
class corrReceiveView extends Component {
    ...
    constructor(props) {
       ...
       var recivedColumns = [
        ...
        this.state = {
            ...
            rows:[],
            pageTitle: Resources["communicationCorrespondenceReceived"][currentLanguage],
            columns:recivedColumns
        }
    ...
    componentDidMount() {
        ...
        Api.get("GetCommunicationCorrespondenceReceivedForEdit?id=" + docId).then(
            res => {
                this.setState({
                    initObj: res,
                    rows:res,
        ...
        return (
            ...
            <div className="mainContainer">
                <div className="documents-stepper noTabs__document readOnly_inputs" >
                    <HeaderDocument projectName={projectName} isViewMode={this.state.isViewMode} perviousRoute={this.state.perviousRoute} docTitle={Resources.communicationCorrespondenceReceived[currentLanguage]} moduleTitle={Resources['communication'][currentLanguage]} />
