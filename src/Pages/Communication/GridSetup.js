...
class GridSetup extends Component {
    ...
    scrolllll() {
        ...
        document.getElementById(
            "empty__div--scroll"
        ).style.width = document.getElementById("scrollWidthDiv").style.width;
