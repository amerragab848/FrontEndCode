...
const validationSchema = Yup.object().shape({
    ...
    companyId: Yup.string().required(Resources['selectCompany'][currentLanguage]).nullable(true),
...
const WorkActivitySchema = Yup.object().shape({
    details: Yup.string().required(Resources['descriptionRequired'][currentLanguage]).nullable(true),
    arrange: Yup.number().required(Resources['selectNumber'][currentLanguage]).typeError(Resources['onlyNumbers'][currentLanguage]),
});

const FieldForceSchema = Yup.object().shape({
    fieldForceId: Yup.string().required(Resources['selectFieldForce'][currentLanguage]).nullable(true),
    disciplineId: Yup.string().required(Resources['disciplineRequired'][currentLanguage]).nullable(true),
    area: Yup.string().required(Resources['areaRequired'][currentLanguage]).nullable(true),
    arrange: Yup.number().required(Resources['selectNumber'][currentLanguage]).typeError(Resources['onlyNumbers'][currentLanguage]),
    amount: Yup.number().typeError(Resources['onlyNumbers'][currentLanguage]).nullable(true),
});

const MaterialSchema = Yup.object().shape({
    description: Yup.string().required(Resources['descriptionRequired'][currentLanguage]).nullable(true),
    companyId: Yup.string().required(Resources['selectCompany'][currentLanguage]).nullable(true),
    arrange: Yup.number().required(Resources['selectNumber'][currentLanguage]).typeError(Resources['onlyNumbers'][currentLanguage]),
    areaId: Yup.string().required(Resources['areaRequired'][currentLanguage]).nullable(true),
    unitId: Yup.string().required(Resources['unitSelection'][currentLanguage]).nullable(true),
...
const EquipmentSchema = Yup.object().shape({
    ...
    arrange: Yup.number().required(Resources['selectNumber'][currentLanguage]).typeError(Resources['onlyNumbers'][currentLanguage]),
    areaId: Yup.string().required(Resources['areaRequired'][currentLanguage]).nullable(true),
    equipmentunitId: Yup.string().required(Resources['unitSelection'][currentLanguage]).nullable(true),
    equipmenttypeId: Yup.string().required(Resources['equipmentTypeSelection'][currentLanguage]).nullable(true),
    quantity: Yup.number().required(Resources['quantityRequired'][currentLanguage]).typeError(Resources['onlyNumbers'][currentLanguage]),
});

const VisitorsSchema = Yup.object().shape({
    companyId: Yup.string().required(Resources['selectCompany'][currentLanguage]).nullable(true),
    contactId: Yup.string().required(Resources['fromContactRequired'][currentLanguage]).nullable(true),
    arrange: Yup.number().required(Resources['selectNumber'][currentLanguage]).typeError(Resources['onlyNumbers'][currentLanguage]),
});

const WeatherSchema = Yup.object().shape({
    weatherId: Yup.string().required(Resources['fromToRequired'][currentLanguage]).nullable(true),
    fromToId: Yup.string().required(Resources['selectWeather'][currentLanguage]).nullable(true),
    arrange: Yup.number().required(Resources['selectNumber'][currentLanguage]).typeError(Resources['onlyNumbers'][currentLanguage]),
});
                        ...
                        {({ errors, touched, handleBlur, handleChange, handleSubmit, setFieldValue, setFieldTouched }) => (
                            <Form id="QsForm" className="customProform" noValidate="novalidate" onSubmit={handleSubmit}>
                                ...
                                <div className="proForm datepickerContainer">
                                    ...
                                    <div className="linebylineInput valid-input">
                                        <Dropdown isClear={true} title="CompanyName" data={this.state.CompaniesData} selectedValue={this.state.selectedCompany}
                            ...
                            {({ errors, values, touched, setFieldTouched, setFieldValue, handleBlur, handleChange }) => (
                                <Form id="voItemForm" className="proForm datepickerContainer customProform" noValidate="novalidate" >
                                    <div className='document-fields'>
                                        ...
                                        <div className="proForm first-proform">
                                            <div className="linebylineInput valid-input">
                                                <Dropdown  isClear={true} title="discipline" data={this.state.disciplineData} selectedValue={this.state.selectedDiscplineForce}
                                        ...
                                        <div className="proForm datepickerContainer">
                                            ...
                                            <div className="linebylineInput valid-input">
                                                <Dropdown isClear={true}  title="fieldForce" data={this.state.fieldForceData} selectedValue={this.state.selectedFieldForce}
                                            ...
                                            <div className="linebylineInput valid-input">
                                                <Dropdown isClear={true} title="area" data={this.state.areaData} selectedValue={this.state.selectedAreaForce}
                                ...
                                <Form id="voItemForm" className="proForm datepickerContainer customProform" noValidate="novalidate" >
                                    <div className='document-fields'>
                                        ...
                                        <div className="proForm datepickerContainer">
                                            ...
                                            <div className="linebylineInput valid-input">
                                                <Dropdown isClear={true} title="CompanyName" data={this.state.CompaniesData} selectedValue={this.state.selectedCompanyMaterial}
                                            ...
                                            <div className="linebylineInput valid-input">
                                                <Dropdown isClear={true} title="area" data={this.state.areaData} selectedValue={this.state.selectedAreaMaterial}
                                            ...
                                            <div className="linebylineInput valid-input">
                                                <Dropdown isClear={true} title="unit" data={this.state.unitData} selectedValue={this.state.selectedUnitMaterial}
                                ...
                                <Form id="voItemForm" className="proForm datepickerContainer customProform" noValidate="novalidate" >
                                    <div className='document-fields'>
                                        ...
                                        <div className="proForm datepickerContainer">
                                            ...
                                            <div className="linebylineInput valid-input">
                                                <Dropdown isClear={true} title="CompanyName" data={this.state.CompaniesData} selectedValue={this.state.selectedCompanyEquipment}
                                            ...
                                            <div className="linebylineInput valid-input">
                                                <Dropdown isClear={true} title="area" data={this.state.areaData} selectedValue={this.state.selectedAreaEquipment}
                                            ...
                                            <div className="linebylineInput valid-input">
                                                <Dropdown isClear={true} title="unit" data={this.state.unitData} selectedValue={this.state.selectedUnitEquipment}
                                            ...
                                            <div className="linebylineInput valid-input">
                                                <Dropdown isClear={true} title="equipmentType" data={this.state.equipmentData} selectedValue={this.state.selectedEquipment}
                                ...
                                <Form id="voItemForm" className="proForm datepickerContainer customProform" noValidate="novalidate" >
                                    <div className='document-fields'>
                                        <div className="proForm datepickerContainer">
                                            ...
                                            <div className="linebylineInput valid-input">
                                                <Dropdown isClear={true}  title="CompanyName" data={this.state.CompaniesData} selectedValue={this.state.selectedVisitorsCompany}
                                            ...
                                            <div className="linebylineInput valid-input">
                                                <Dropdown isClear={true} title="ContactName" data={this.state.contactsVisitors} selectedValue={this.state.selectedVisitorsContact}
                                ...
                                <Form id="voItemForm" className="proForm datepickerContainer customProform" noValidate="novalidate" >
                                    <div className='document-fields'>
                                        <div className="proForm datepickerContainer">
                                            ...
                                            <div className="linebylineInput valid-input">
                                                <Dropdown isClear={true} title="weather" data={this.state.weatherData} selectedValue={this.state.selectedWeather}
                                            ...
                                            <div className="linebylineInput valid-input">
                                                <Dropdown isClear={true} title="weatherFromTo" data={this.state.fromToData} selectedValue={this.state.selectedFromTo}
