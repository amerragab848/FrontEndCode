...
class ContractInsurance extends Component {
  ...
  saveInsurance() {
    ...
    saveDocument.effectiveDate = moment(saveDocument.effectiveDate, 'YYYY-MM-DD').format('YYYY-MM-DD[T]HH:mm:ss.SSS');
    saveDocument.expirationDate = moment(saveDocument.expirationDate, 'YYYY-MM-DD').format('YYYY-MM-DD[T]HH:mm:ss.SSS');
                              ...
                              <div className="customDatepicker fillter-status fillter-item-c ">
                                <div className="proForm datepickerContainer">
                                  <div className="linebylineInput valid-input alternativeDate">
                                    <DatePicker title='effectiveDate'
                                      startDate={this.state.document.effectiveDate}
                                      handleChange={e => this.handleChangeDate(e, "effectiveDate")} />
                                  </div>
                                </div>
                              </div>
                            </div>
                          ...
                          <div className="linebylineInput valid-input">
                            <div className="inputDev ui input input-group date NormalInputDate">
                              <div className="customDatepicker fillter-status fillter-item-c ">
                                <div className="proForm datepickerContainer">
                                  <div className="linebylineInput valid-input alternativeDate">
                                    <DatePicker title='expirationDate'
                                      startDate={this.state.document.expirationDate}
                                      handleChange={e => this.handleChangeDate(e, "expirationDate")} />
                                  </div>
                                </div>
                              </div>
                            </div>
