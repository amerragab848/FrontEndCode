...
const validationSchema = Yup.object().shape({
    policyType: Yup.string()
        .required(Resources["policyType"][currentLanguage])
        .max(450, Resources["maxLength"][currentLanguage]),
    companyId: Yup.string()
        .required(Resources["pleaseSelectYourCompany"][currentLanguage])
        .nullable(true)
});
...
class ContractInsurance extends Component {
    ...
    componentWillMount() {
        ...
        dataservice
            .GetDataGrid(this.state.ApiGet + this.state.contractId)
            .then(data => {
    ...
    saveInsurance() {
        ...
        saveDocument.effectiveDate = moment(
            saveDocument.effectiveDate,
            "YYYY-MM-DD"
        ).format("YYYY-MM-DD[T]HH:mm:ss.SSS");
        saveDocument.expirationDate = moment(
            saveDocument.expirationDate,
            "YYYY-MM-DD"
        ).format("YYYY-MM-DD[T]HH:mm:ss.SSS");
    ...
    clickHandlerContinueMain() {
        ...
        dataservice
            .addObject(this.state.ApiDelete + id)
            .then(result => {
        ...
        return (
            <div
                ...
                <div className="doc-pre-cycle letterFullWidth">
                    <header>
                        <h2 className="zero">
                            {Resources["addInsurance"][currentLanguage]}
                        </h2>
                    </header>
                </div>
