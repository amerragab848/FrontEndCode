...
class boqAddEdit extends Component {
    ...
    checkDocumentIsView() {
        if (this.props.changeStatus === true) {
            if (Config.getPayload().uty === 'company') {
                ...
                if (
                    !Config.IsAllow(617) &&
                    this.props.document.contractId !== null
                ) {
    ...
    addPoq = values => {
        ...
        let documentObj = {
            project: this.state.projectId,
            documentDate: moment(values.documentDate, 'YYYY-MM-DD').format(
        ...
        DataService.addObject('AddBoq', documentObj)
            .then(result => {
    ...
    renderingGrid() {
        const ItemsGrid = this.state.isLoading === false && this.state.CurrStep === 1 ? (
            <GridCustom
                gridKey='KO_boqIems'
                cells={this.boqItems}
                ...
                <div className="doc-pre-cycle letterFullWidth">
                    ...
                    <div className="precycle-grid">
                        ...
                        <div className="slider-Btns">
                            <button className="primaryBtn-1 btn meduimBtn  " type="submit" onClick={() => this.changeCurrentStep(2)}>{Resources.next[currentLanguage]}</button>
                        </div>
                    </div>
                </div>
            </Fragment>
            ...
            <Fragment>
                ...
                <div className="company__total proForm">
                    <div className="form-group linebylineInput ">
                        ...
                        <div
                            className="ui right labeled input inputDev  "
                            style={{ display: 'flex' }}>
                            <input
                                className="form-control"
                                autoComplete="off"
            ...
            <Fragment>
                <div className="mainContainer">
                    ...
                    <div
                        ...
                        style={{ display: this.state.showBoqModal ? 'block' : 'none', }}>
                        <SkyLight
                            hideOnOverlayClicked
