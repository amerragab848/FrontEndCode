...
class ProcurmentRequestFormAddEdit extends Component {
    ...
    fillDropDowns(isEdit) {
        ...
        dataservice.GetDataListCached("GetProjectProjectsCompaniesForList?projectId=" + this.state.projectId, "companyName", "companyId", 'companies', this.state.projectId, "projectId").then(result => {
            //contractList
            dataservice.GetDataList("GetAllContractsForDropDown", "value", "id").then(result => {
                this.setState({
                    contracts: [...result]
                });
                if(isEdit){
                ...
                if (contractId) {
                    ...
                    contractLabel=this.state.contracts.find(i=>i.value==contractId);
                    this.setState({
                        selectedContract: {
            ...
            if (isEdit) {
                ...
                if (contractId) {
                 //  let list= this.state.contracts;
                   // let contractLabel= this.state.contracts.find(i=>i.value==contractId);
                    this.setState({
                        selectedContract: {
                            label: contractLabel,
                            value: contractId
    ...
    saveAndExit(event) {
        ...
        if (replyId) {
            this.props.history.push({
                pathname: '/contractProcurmentRequestForm/' + this.props.projectId,
            });
        } else {
            this.props.history.push(this.state.perviousRoute);
        }
                                                ...
                                                <Form id="letterForm" className="customProform" noValidate="novalidate" onSubmit={handleSubmit}>
                                                    ...
                                                    <Fragment>
                                                        <header className="main__header">
                                                            <div className="main__header--div">
                                                                <h2 className="zero">
                                                                    {Resources["mainSection"][currentLanguage]}
                                                                </h2>
                                                            </div>
                                                        </header>
                                                        ...
                                                        <div className="proForm datepickerContainer">
                                                          ...
                                                          { this.state.docId>0? <div className="linebylineInput valid-input">
                                                                <label className="control-label">
                                                    ...
                                                    <Fragment>
                                                        <header className="main__header">
                                                            <div className="main__header--div">
                                                                <h2 className="zero">
                                                                    {Resources["directAwardSection"][currentLanguage]}
                                                                </h2>
                                                            </div>
                                                        </header>
                                                        <div className="proForm datepickerContainer">
                                                    ...
                                                    <Fragment>
                                                        <header className="main__header">
                                                            <div className="main__header--div">
                                                                <h2 className="zero">
                                                                    {Resources["bugetSection"][currentLanguage]}
                                                                </h2>
                                                            </div>
                                                        </header>
                                                        <div className="proForm datepickerContainer">
