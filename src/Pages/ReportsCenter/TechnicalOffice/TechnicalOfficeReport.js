...
class TechnicalOfficeReport extends Component {
    ...
    getChartData = () => {
        if (this.state.project.value != '-1') {
            ...
            let currentComponent = <BarChartComp api={'GetTechnicalOfficeDocument'} sendingObj={reportobj} catagName={'docName'} catagValue={'count'}
                title={Resources['technicalOfficeDocument'][currentLanguage]} yTitle={Resources['total'][currentLanguage]} seriesName={Resources['count'][currentLanguage]} />
