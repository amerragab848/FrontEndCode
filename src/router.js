...
const requestPaymentsAddEdit_old = AsyncComponent(() =>
    import('./Pages/Contracts/requestPaymentsAddEdit_old'),
);
...
let originalRoutes = [
    ...
    <Route key="r-96" path="/requestPaymentsAddEdit_old" component={requestPaymentsAddEdit_old} />,
