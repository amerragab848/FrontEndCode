...
/***/ (function(module, exports, __webpack_require__) {
	...
	var getSelectedRangeDimensions = exports.getSelectedRangeDimensions = function getSelectedRangeDimensions(_ref3) {
	  ...
	  if (topLeft.idx < 0) {
		return { width: 0, [currentLanguage == "ar" ? right : left] : 0, top: 0, height: rowHeight, zIndex: _zIndexes2['default'].CELL_MASK }
		}
	  ...
	  var zIndex = anyColFrozen ? _zIndexes2['default'].FROZEN_CELL_MASK : _zIndexes2['default'].CELL_MASK;
		...
		return { width: totalWidth, [currentLanguage == "ar" ? right : left] : left, top: top, height: height, zIndex: zIndex }
	};
